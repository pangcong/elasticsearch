 ...
 */
public class ImageFeatureScoreQuery extends Query {
  ...
  public ImageFeatureScoreQuery(Filter filter, Query query) {
      this.filter = filter;
   ...
   public ImageFeatureScoreQuery(Query query) {
    if (query == null)
   ...
   * use {@link #ImageFeatureScoreQuery(org.apache.lucene.search.Query)}!
   */
  public ImageFeatureScoreQuery(Filter filter) {
    if (filter == null)
  ...
  protected class ConstantWeight extends Weight {
    ...
    @Override
    public Query getQuery() {
      return ImageFeatureScoreQuery.this;
    }
  ...
  public Weight createWeight(IndexSearcher searcher) throws IOException {
    return new ImageFeatureScoreQuery.ConstantWeight(searcher);
  }
  ...
  public boolean equals(Object o) {
    ...
    if (!super.equals(o))
      return false;
    if (o instanceof ImageFeatureScoreQuery) {
      final ImageFeatureScoreQuery other = (ImageFeatureScoreQuery) o;
      return 
